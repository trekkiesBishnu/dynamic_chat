...
<head>
    ...
    <title>Dynamic Chat Website</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="navbar custom-navbar navbar-expand-md navbar-light fixed-top" data-spy="affix" data-offset-top="10">
        <div class="container">
            ...
            @if (Route::has('login'))
                    ...
                    <a class="nav-link text-white flex-end btn ml-4 nav-link btn btn-primary btn-sm rounded "  href="{{ route('login') }}">Log In</a>
              
            @endif

            @if (Route::has('register'))
                    <a class="nav-link text-white ml-4 nav-link btn btn-success btn-sm rounded
        ...
        @else
            {{-- <li class="nav-item dropdown"> --}}
                ...
                <li class="nav-item">
                    <a class="btn text-white ml-4 nav-link btn btn-success btn-sm rounded" href="{{ route('home') }}" >Home</a>
                </li>
                <li class="nav-item">
    ...
    <header class="header">
        ...
        <div class="overlay">
            @if (Auth::id())
                <h3 class="bg-dark">Hello <b class="text-light">{{ Auth::user()->name }}</b> </b></h3>
            @endif
    ...
    <section  id="service" class="section pt-0">
        <div class="container">
            ...
            <h6 class="section-subtitle text-center mb-5 pb-3">Post and Chat With Your Friends.</h6>

            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            <small class="text-primary font-weight-bold">First</small>
                            <h5 class="card-title mt-3"> Post Your Photo <h5>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            <small class="text-primary font-weight-bold">Second</small>
                            <h5 class="card-title mt-3">Chat With Friend<h5>
                            <p class="mb-0">Lorem ipsum dolor sit amet, cquasi cupiditate voluptate debitis saepe dolorem totam dolor repudiandae quo nihil, repellendus nesciunt ab fuga quae, minima reprehenderit sequi fugit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        <div class="card-body">
                            <small class="text-primary font-weight-bold">Third</small>
                            <h5 class="card-title mt-3">Keep Your Information<h5>
                            <p class="mb-0">Lorem ipsum dolor sit amet, cquasi cupiditate voluptate debitis saepe dolorem totam dolor repudiandae quo nihil, repellendus nesciunt ab fuga quae, minima reprehenderit sequi fugit.</p>
                        </div>
                    </div>
                </div>              
    ...
    <!-- LeadMark js -->
    {{-- <script src="{{ asset('front/assets/js/leadmark.js') }}"></script> --}}
